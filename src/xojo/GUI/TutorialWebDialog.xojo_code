...
Begin WebDialog TutorialWebDialog
   ...
   Begin WebLabel IntroductionLabel
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel ExamplesTitleLabel
      Bold            =   True
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin GridLetter GridLetter5
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel CorrectExampleLabel
      Bold            =   False
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin GridLetter GridLetter10
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel MissedExampleLabel
      Bold            =   False
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin GridLetter GridLetter15
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel FailedExampleLabel
      Bold            =   False
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
...
#tag Events IntroductionLabel
	#tag Event
		Sub Opening()
		  Me.Style.Value("line-height") = "20px"
		End Sub
	#tag EndEvent
#tag EndEvents
